...
class ResBottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = Conv(expansion_channel, expansion_channel, 3, 1, groups=groups)
        self.conv3 = Conv(expansion_channel, out_channels, 1, 1, activation=activation)
...
class ResBottleneckGenerator(GeneratorAbstract):
